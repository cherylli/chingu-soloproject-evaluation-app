...
const ScrumMasterDetails = ({ fields }: { fields: SoloProjectFields }) => {
    ...
    <>
      ...
      <Table>
        <TableBody>
          <TableRow>
            <TableCell>
              SM20: Describe the roles and responsibilities of the Scrum Master, the Product Owner,
              and the Development Team in a Scrum project.
          ...
          <TableRow>
            <TableCell>
              SM21: Explain the concept of “user stories” and how they are used in Scrum. Provide an
          ...
          <TableRow>
            <TableCell>
              SM22: Discuss the importance of the Sprint Retrospective and how it contributes to
